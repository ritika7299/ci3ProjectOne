      ...
      <div class="video-overlay header-text">
          <div class="caption">
              ...
              <div class="signin-button">
                  <a href="<?php echo base_url();?>Auth/signin"><button type="submit" class="btn btn-warning">Sign-in <i class="fa fa-sign-in" aria-hidden="true"></i></button></a>
              </div>
          </div>
      </div>
  </section>
          ...
          <div class="features-post second-features">
            <div class="features-content">
              ...
              <div class="content-hide">
                <p>Curabitur id eros vehicula, tincidunt libero eu, lobortis mi. In mollis eros a posuere imperdiet. Donec maximus elementum ex. Cras convallis ex rhoncus, laoreet libero eu, vehicula libero.</p>
                <p class="hidden-sm">Curabitur id eros vehicula, tincidunt libero eu, lobortis mi. In mollis eros a posuere imperdiet.</p>
                <div class="scroll-to-section"><a href="<?php echo base_url();?>FreshAddmission/index" type="click">click here</a></div>
            </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <article class="video-item">
            ...
            <figure>
              <a href="https://www.youtube.com/watch?v=r9LtOG6pNUw" class="play"><img src="<?php echo base_url();?>assetshome//images/main-thumb.png"></a>
            </figure>
          </article>
        </div>
      </div>
