      ...
      <div class="card-body register-card-body">
        ...
        <form method="post" action="">
          <div class="input-group mb-3">
            <input type="text" class="form-control" id="username" name="username" value="" size="50"
          ...
          <div class="input-group mb-3">
            <input type="email" class="form-control" id="address" name="address" value="" size="50"
              placeholder="Address">
            <div class="input-group-append">
              <div class="input-group-text">
          ...
          <div class="row">
            ...
            <!-- /.col -->
            <div class="col-4">
              <button type="submit" class="btn btn-primary btn-block">Submit <i class="fa fa-paper-plane"
                  aria-hidden="true"></i>
              </button>
            </div>
            <!-- /.col -->
